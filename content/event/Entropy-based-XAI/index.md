...
address:
  ...
  postcode:
  country:
summary: This research paper aims at building an entropy layer for end-to-end explainable AI framework. Unlike LIME and Grad-CAM this Entropy Net will not rely on any auxuliary tool/model to explain its predictions. Also, this Entropy Net focuses on downsizing the concepts reqiored to explain predictions.
